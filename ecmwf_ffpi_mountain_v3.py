...
# =========================================================
# ECMWF Experimental FFPI - Mountain V3
...
# Includes Jeddah, Makkah, Taif, Oman, Iraq, Iran, Pakistan
# =========================================================
LAT_MIN = 5.0
LAT_MAX = 45.0
LON_MIN = 25.0
...
cb = plt.colorbar(plot, ax=ax, orientation="vertical", pad=0.025, shrink=0.85)
